...
const specialityRows: Speciality[] = [
  { id: 'spec-pk', code: 'ПК', name: 'Комп’ютерні науки та програмування', description: 'Алгоритми, веброзробка, бази даних, програмні системи та командна робота над цифровими продуктами.' },
  { id: 'spec-ek', code: 'ЕК', name: 'Економіка', description: 'Фінансові розрахунки, економічний аналіз, планування, підприємництво та робота з діловими даними.' },
  { id: 'spec-or', code: 'ОР', name: 'Організація ресторанного обслуговування', description: 'Сервісні процеси, комунікація з клієнтами, організація командної роботи та стандарти обслуговування.' },
  { id: 'spec-dz', code: 'ДЗ', name: 'Дизайн зачіски та стилю', description: 'Композиція образу, колористика, візуальна культура, робота з клієнтом і підготовка професійного портфоліо.' },
  { id: 'spec-dv', code: 'ДВ', name: 'Дизайн візуального середовища', description: 'Графічні рішення, макетування, айдентика, презентаційні матеріали та візуальна комунікація.' },
];
